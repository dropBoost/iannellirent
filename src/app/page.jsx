  ...
  <div className="flex min-h-dvh h-dvh flex-col p-3 bg-radial-[at_25%_100%] from-neutral-950 via-neutral-900 via-60% to-brand to-100%  text-neutral-200">
    <main className="flex flex-col flex-1 rounded-4xl gap-4 p-3">
      ...
      <div className="flex lg:flex-row flex-col flex-1 rounded-4xl gap-0 bg-brand/50 p-2 shadow-2xl">
        <div className="group relative flex basis-1/3 overflow-hidden lg:rounded-s-4xl lg:rounded-tr-none rounded-s-none rounded-t-4xl">
          ...
          <div className="relative z-10 flex w-full items-center justify-end text-white">
            <ButtonElement label={"Auto e Moto"} link={`/car-moto`}/>
          </div>
        </div>
        <div className="group relative flex basis-1/3 overflow-hidden">
          ...
          <div className="relative z-10 flex w-full items-center justify-end text-white">
            <ButtonElement label={"Veicoli Commerciali"} link={`#`}/>
          </div>
        </div>
        <div className="group relative flex basis-1/3 overflow-hidden lg:rounded-e-4xl lg:rounded-bl-none rounded-e-none rounded-b-4xl ">
...
export function ButtonElement ({label, link}) {
  return (
    <Link href={link} target="_parent" className="bg-brand/90 text-neutral-100 hover:text-neutral-100 hover:bg-brand px-5 py-1 uppercase lg:text-xl text-sm font-bold shadow-2xl bg-radial-[at_15%_100%] from-neutral-950/70 to-brand/80 to-100% ">
      {label}
    </Link>
  )
}